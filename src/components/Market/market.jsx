...
const Marketplace = ({toggleWishlistItem, addToCart }) => {
  const items = [
        ...
        {items.map((item) => (
          <div key={item.id} className="bg-white p-4 shadow-lg rounded-lg w-full h-100 overflow-hidden">
            ...
            <div className="p-4">
              ...
              <button className="mt-4 mr-16 bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 rounded" onClick={() => toggleWishlistItem(item)}>Add To Wishlist</button>
